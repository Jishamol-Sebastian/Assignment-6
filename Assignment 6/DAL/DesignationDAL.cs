...
namespace Assignment_6.DAL
{
    public class DesignationDAL
    {
        ...
        {
            string s = "select d.*,dept.* from tbl_Designation d inner join tbl_Department dept on d.Dept_id=dept.Dept_id";
        ...
        {
            string s = "update tbl_Designation set Design_name='" + obj.DesignationName + "',Dept_id='" + obj.DepartmentId + "' where Design_id='" + obj.DesignationId + "'";
            SqlCommand cmd = new SqlCommand(s, Getcon());
            return cmd.ExecuteNonQuery();
        ...
        {
            string s = "Delete from tbl_Designation where Design_id='" + obj.DesignationId + "'";
            SqlCommand cmd = new SqlCommand(s, Getcon());
            return cmd.ExecuteNonQuery();
